...
export const t = {
  ...
  groups: {
    ...
    joinByCodeDesc: "Guruh yoki testning kirish kodini kiriting (8 belgili).",
    joinCodePh: "Masalan: A7K9XQ2M",
    ...
    leaderboardEmpty: "Hali natijalar yo'q",
    ...
    asMemberBadge: "A'zo sifatida",
    asCreatorBadge: "Yaratuvchi",
    yourBest: "Sizning eng yaxshi natijangiz",
